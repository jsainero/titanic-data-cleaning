...
author: "Alvaro Lopez y Jorge Sainero"
...
Para las variables _SibSp_, _Parch_ y _NameAbbreviation_ además de los diagramas de barras, optamos por estandarizar cada barra para que tenga la misma altura y muestre las proporciones relativas para apreciar bien todos los grupos.
...
El p-valor = 0.1425 > 0.05. De esta manera, se acepta la hipótesis nula y se concluye que la variable _Age_ presenta varianzas estadísticamente iguales para los dos grupos de _Survived_.

Esto se puede representar con los boxplots visualizados en el apartado 4.1. La amplitud de la caja y de los bigotes del grupo que no sobrevivió es un poco mayor a la amplitud del grupo que sobrevivió. Esta diferencia pequeña es aceptada asumiendo igualdad de varianzas para las dos distribuciones.
